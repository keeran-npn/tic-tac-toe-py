"""
Tic Tac Toe players using implementation
"""
...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            ...
            # it into an integer, and if it's not, then we say its invalid
...
class GeniusComputerPlayer(Player):
    ...
    def minmax(self, state, player):
        ...
        # first, we want to check whether the previous move is a winner
